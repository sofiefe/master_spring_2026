...
from sklearn.metrics import fbeta_score, precision_recall_curve, f1_score
...
HP = {
    ...
    "weight_decay": 0.0,
    "warmup_ratio": 0.05,
    "model_name": "xlm-roberta-base",  # xlm-roberta-base  google-bert/bert-base-multilingual-cased
    "random_state": 2018,
