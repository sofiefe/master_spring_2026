...
HP = {
    "test_nr": "multi base sweep simple",
    "max_length": 350,
    "batch_size": 64,
    "learning_rate": 2e-5,
    "epochs": 10,
...
training_data_run = training_data
...
train_valid_run_dict = DatasetDict(
    {
...
def train():
    ...
    trainer = WeightedTrainer(
        ...
        args=training_args,
        train_dataset=train_valid_run_dict["train"],
        eval_dataset=train_valid_run_dict["validation"],
